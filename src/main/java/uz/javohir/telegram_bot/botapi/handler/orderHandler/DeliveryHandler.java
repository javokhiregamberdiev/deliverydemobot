...
@Component
public class DeliveryHandler implements InputMessageHandler {
    @Autowired
    private OrderService orderService;

    @Override
    public SendMessage handle(Message message) {
        return orderService.getOrderMessage(message.getChatId(), "Delivery service is not ready yet.");
    }

    @Override
    public BotState getHandlerName() {
        return BotState.DELIVERY;
    }
}
